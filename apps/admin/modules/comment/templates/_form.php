...
<?php endif; ?>
  <table>
    ...
    <tbody>
      ...
      <tr>
        <th><?php echo $form['request_id']->renderLabel() ?></th>
        <td>
          <?php echo $form['request_id']->renderError() ?>
          <?php echo $form['request_id'] ?>
        </td>
      </tr>
      <tr>
        <th><?php echo $form['theme_id']->renderLabel() ?></th>
        <td>
          <?php echo $form['theme_id']->renderError() ?>
          <?php echo $form['theme_id'] ?>
        </td>
      </tr>
      <tr>
